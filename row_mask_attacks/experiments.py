...
experiments = [
    {   # Agg Dinur-style, testing max_num_contingency_tables
        'dont_run': True,
        'used_in_paper': True,
        'experiment_group': 'agg_dinur_nrows_testing_max_num_contingency_tables',
        'solve_type': 'agg_row',
        'nrows': [300],
        'mask_size': [0],
        'nunique': [2],
    ...
    {   # Agg Dinur-style, initial parameter spread
        'dont_run': True,
        'used_in_paper': True,
        'experiment_group': 'agg_dinur_initial_parameter_spread',
        'solve_type': 'agg_row',
        'nrows': [300],
        'mask_size': [0],
        'nunique': [2],
        'noise': [0, 1, 2, 4, 7, 10],
        'max_num_contingency_tables': [20, 40, 80, 100],
        'nqi': [11],
        'min_num_rows': [1, 2, 3, 5, 8],
        'vals_per_qi': [2],
        'corr_strength': [0.0],
        'known_qi_fraction': [1.0],
        'max_qi': [1000],
